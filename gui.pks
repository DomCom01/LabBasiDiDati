...
procedure aggiungiForm(classe VARCHAR2 default '', name VARCHAR2 default '', url VARCHAR default '');
procedure AggiungiInput(tipo VARCHAR2 default 'text', nome VARCHAR2 default '', value VARCHAR2 default '',  placeholder VARCHAR2 default '', required BOOLEAN default false, classe VARCHAR2 default '', ident VARCHAR2 default '');
